    ...
    <div className="relative ipad:px-4 w-full ipad:w-[55%] ipad:h-full flex-center  flex-col ipad:gap-2 gap-5 tablet:gap-10 laptop:gap-7 overflow-auto">
      ...
      {!hasErrors && (
        <div className="w-max h-max">
          <img src={roundedLogo} alt="" width={70} />
        </div>
      )}
      <form
      ...
      >
        <FormInput
          ...
          otherStyles="px-3 h-12 mobile:py-3 py-2 tablet:py-4 laptop:py-2.5 ipad:py-2 text-xs rounded-lg"
          {...register("firstName")}
        ...
        <Button
          ...
          otherStyles=" ipad:h-10 tablet:h-16 rounded-xl"
        />
      </form>
      {/* <GoogleButton /> */}
      {!show && (
